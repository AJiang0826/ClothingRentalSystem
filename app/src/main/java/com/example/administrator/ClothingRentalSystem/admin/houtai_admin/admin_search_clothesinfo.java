...
public class admin_search_clothesinfo extends AppCompatActivity {
    ...
    private ResultSet rs;//Resultset【结果集】主要用于接收JDBC查询语句返回的数据集对象
    ...
    private void init() {
        ...
        Bundle bundle=this.getIntent().getExtras();//得到intent所附带的数据
...
//        System.out.println("sql="+sql);
        ...
        try {
            ...
            SimpleAdapter adapter = new SimpleAdapter(
                    ...
                    new String[]{"Clothes_Info_Img", "Clothes_Name", "Clothes_Author", "Clothes_Type", "Clothes_Price", "Clothes_Rank", "Clothes_Publish"},//admin_clothes_item1
                    new int[]{R.id.Clothes_Info_Img, R.id.Clothes_Name, R.id.Clothes_Author, R.id.Clothes_Type, R.id.Clothes_Price, R.id.Clothes_Rank, R.id.Clothes_Publish});//admin_clothes_item1
